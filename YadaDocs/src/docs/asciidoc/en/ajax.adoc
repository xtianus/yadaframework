...
[TIP]
====
When deleting both the element and something else, the empty selector must be
placed at the end of the list or the deletion might not work properly when using an extended selector. For example: `"yadaSiblings:div,"`
====
