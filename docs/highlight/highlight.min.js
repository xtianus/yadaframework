...
variants:[e.BINARY_NUMBER_MODE,e.C_NUMBER_MODE]}]})})());hljs.registerLanguage("less",(()=>{"use strict";return e=>{
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("accesslog",(()=>{"use strict";return e=>{
...
begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("groovy",(()=>{"use strict";function e(e,n={}){
...
excludeBegin:!0,end:a+":",relevance:0}],illegal:/#|<\//};var l}})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
...
starts:i},{className:"attr",relevance:0,begin:s+n+"$"}]}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
...
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("gradle",(()=>{"use strict";return e=>({name:"Gradle",
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
skip:!0})]}]})})());hljs.registerLanguage("asciidoc",(()=>{"use strict";return e=>({name:"AsciiDoc",
...
excludeBegin:!0,excludeEnd:!0,relevance:0}],relevance:10}]})})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
